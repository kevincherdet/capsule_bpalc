...
### Présentation du socle Banque Populaire Alsace Lorraine Champagne
<!-- layout: cover -->
...
<!-- thumbnail: sommaire_champ_application.jpg -->

### Champ d'application
<!-- layout: image-right-square -->
<!-- image: champ_application.jpg -->

Cette capsule précise les règles applicables spécifiquement aux collaborateurs de la Banque Populaire Alsace Lorraine Champagne.

Elle a pour objectif d'articuler vos droits selon deux niveaux de textes :

- La convention collective de la **Branche Banque Populaire** qui fait office de socle commun pour les banques du groupe,
...
## Classifications
<!-- thumbnail: sommaire_classif.jpg -->

### Principe
<!-- layout: image-right-square -->
<!-- image: classifications_principe.jpg -->
...
:::popup Consulter les salaires minimums
Chaque niveau de classification est associé à un **salaire minimum hiérarchique (SMH)** revalorisé chaque année par accord de branche.

Le SMH constitue le plancher en dessous duquel un salarié de ce niveau ne peut pas être rémunéré. Il sert de base au calcul de nombreux éléments de rémunération.
:::

</div>

Votre convention collective (Banque Populaire) applique la grille de classification de la convention collective de la banque pour tous ses salariés. Celle-ci comporte **11 niveaux** de classification. 7 niveaux sont à destination des techniciens, 4 à destination des cadres.

<div style="display:flex;gap:16px;flex-wrap:wrap;justify-content:center">
<button class="popup-btn" onclick="navigateToTitle('Grille des techniciens')">Voir la grille des techniciens</button>
<button class="popup-btn" onclick="navigateToTitle('Grille des cadres')">Voir la grille des cadres</button>
</div>
...
<!-- layout: image-right-square -->
<!-- image: classifications_techniciens.jpg -->

Les techniciens sont répartis selon 7 niveaux allant de A à G.

<div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;justify-items:center">

:::popup Niveau A
<h2>Technicien niveau A</h2>

| **Niveau** | **Compétences** |
|:----------:|----------------|
| A | Emplois se caractérisant par l'exécution de tâches simples, répétitives et peu diversifiées. Ce travail est guidé par des modes opératoires, des procédures et des consignes. Il nécessite une capacité d'intégration au sein d'une équipe. |
:::

:::popup Niveau B
<h2>Technicien niveau B</h2>

| **Niveau** | **Compétences** |
|:----------:|----------------|
| B | Emplois nécessitant des connaissances techniques, acquises soit par une formation, notamment dans le cadre de la formation initiale, soit par une expérience. Ces emplois se caractérisent par l'exécution de tâches administratives ou commerciales simples, répétitives et peu diversifiées. Ils peuvent requérir une certaine polyvalence. Le travail est guidé par des modes opératoires, des procédures et des consignes. Il nécessite une capacité d'intégration au sein d'une équipe. |
:::

:::popup Niveau C
<h2>Technicien niveau C</h2>
...
### Grille des cadres
<!-- layout: image-left-portrait -->
<!-- image: classifications_cadres.jpg -->

La grille de classification des cadres comprend quatre niveaux allant de H à K.

Votre convention collective précise que les cadres doivent avoir une capacité à **concevoir, apprécier, décider et entreprendre**. Ils doivent avoir des **qualités relationnelles marquées** ainsi qu'une aptitude **à la créativité et à l'initiative.**

Leurs missions ont un impact financier ou stratégique important sur le développement de l'entreprise.

Certains peuvent avoir des responsabilités de gestion du personnel et de moyens matériels.

<div style="display:flex;gap:12px;flex-wrap:wrap;justify-content:center">

:::popup H
<h2>Cadre niveau H</h2>

| **Niveau** | **Compétences** |
|:----------:|----------------|
| H | Emplois comportant ou non l'animation d'une unité et se caractérisant par des responsabilités nécessitant la connaissance de techniques et d'usages complexes et/ou une compétence professionnelle confirmée.<br><br>Il peut s'agir :<br><br><span class="bullet">•</span>De la gestion de tout ou partie d'une activité, d'une unité d'exploitation ou d'administration<br><br><span class="bullet">•</span>De la réalisation d'études ou de prestations d'assistance, de conseil ou de contrôle |
:::

:::popup I
<h2>Cadre niveau I</h2>

| **Niveau** | **Compétences** |
|:----------:|----------------|
| I | Emplois comportant ou non l'animation d'une unité et se caractérisant par des responsabilités nécessitant la bonne maîtrise de techniques et d'usages complexes liés à un ou plusieurs domaines d'activité.<br><br>Il peut s'agir :<br><br><span class="bullet">•</span>De la gestion d'une activité, d'une unité d'exploitation ou d'administration avec des responsabilités importantes qui varient selon la taille ou la complexité de l'unité<br><br><span class="bullet">•</span>De l'exercice d'une fonction d'étude, de conseil ou de contrôle exigeant une connaissance approfondie |
:::

:::popup J
<h2>Cadre niveau J</h2>

| **Niveau** | **Compétences** |
|:----------:|----------------|
| J | Emplois comportant ou non l'animation d'une unité et se caractérisant par des responsabilités nécessitant une parfaite maîtrise de techniques et d'usages complexes liés à plusieurs domaines d'activité et bénéficiant d'une grande autonomie.<br><br>Il peut s'agir :<br><br><span class="bullet">•</span>De la gestion d'une activité, d'une unité d'exploitation ou d'administration avec des responsabilités importantes qui varient selon la taille ou la complexité de l'unité et donnent au salarié un rôle influent en matière de décisions financières ou de gestion<br><br><span class="bullet">•</span>De l'exercice d'une fonction d'étude, de conseil ou de contrôle exigeant une réelle expertise |
:::

:::popup K
<h2>Cadre niveau K</h2>

| **Niveau** | **Compétences** |
|:----------:|----------------|
| K | Emplois comportant ou non l'animation d'une unité et se caractérisant par des responsabilités faisant appel à des connaissances relevant de domaines diversifiés ou à une expertise dans plusieurs activités connexes et impliquant de concevoir et de prendre, de manière très autonome, notamment en ce qui concerne l'organisation de leur travail, des décisions adaptées aux axes de la politique de l'établissement.<br><br>Il peut s'agir :<br><br><span class="bullet">•</span>De la réalisation des objectifs d'une unité opérationnelle dont la taille et la complexité imposent une délégation d'autorité sur les personnels qui lui sont rattachés<br><br><span class="bullet">•</span>De la participation à l'élaboration de la politique d'une grande fonction, en raison de la contribution au processus de préparation et d'approbation des décisions prises<br><br><span class="bullet">•</span>De l'exercice d'une fonction d'expert |
:::

:::popup Cadres hors classification
<h2>Les cadres hors classification</h2>
...
## Temps de travail
<!-- thumbnail: sommaire_temps_travail.jpg -->
<!-- layout: text-only -->

<div style="display:flex;gap:150px;justify-content:center;flex-wrap:wrap;padding:0 32px">
...
### Droit commun
<!-- layout: image-right -->
<!-- image: droit_commun.jpg -->
<!-- subsection: Durée du travail -->

Votre entité fixe une durée annuelle de travail de **1 607 heures**, soit 35 heures en moyenne par semaine. La BPALC prévoit **4 rythmes de travail** différents :

<span class="bullet">•</span>**Services centraux : 39h sur 5 jours** — 22 jours de RTT par an
:::popup +
Ce rythme concerne les salariés des services centraux (siège). La durée hebdomadaire de 39 heures est compensée par 22 JRTT, ce qui ramène la durée moyenne à 35 heures sur l'année.
:::

<span class="bullet">•</span>**Réseau : 36h30 sur 4,5 jours** — 8 jours de RTT par an
:::popup +
Ce rythme s'applique aux salariés du réseau d'agences. La semaine de 4,5 jours permet une demi-journée de repos hebdomadaire supplémentaire.
:::

<span class="bullet">•</span>**Centres de Relations Clients : 34h45** — 5 jours de RTT par an
:::popup +
Ce rythme est spécifique aux salariés des centres de relations clients (CRC). La durée hebdomadaire réduite à 34h45 génère 5 JRTT annuels.
:::

<span class="bullet">•</span>**Bihebdomadaire : alternance 5 jours / 4 jours** — 8 jours de RTT par an
:::popup +
Ce rythme fonctionne par alternance : une semaine de 5 jours suivie d'une semaine de 4 jours. Il génère 8 JRTT par an.
:::
...
<!-- layout: image-left-portrait -->
<!-- image: heures_supp.jpg -->

Les heures supplémentaires sont décomptées **au-delà de la durée hebdomadaire** prévue par le schéma de travail du salarié et au-delà du plafond annuel de **1 607 heures**. Elles ne peuvent être réalisées que sur **autorisation de la hiérarchie**.
:::popup +
Les heures supplémentaires doivent être expressément demandées ou autorisées par la hiérarchie. Le salarié ne peut pas décider seul d'effectuer des heures supplémentaires.
:::

Le salarié peut choisir entre deux modes de compensation pour ses heures de dépassement validées : **le paiement ou la récupération**.
:::popup +
Les heures récupérées sous forme de repos ne sont pas comptabilisées dans le contingent annuel d'heures supplémentaires.
:::

Le contingent d'heures supplémentaires est fixé à **220 heures** par an. Au-delà, les heures supplémentaires donnent droit à une **contrepartie obligatoire de repos** équivalent à 100%.
...
### Les astreintes
<!-- layout: image-left -->
<!-- image: astreintes.jpg -->

Dans les entreprises du réseau Banque Populaire, la mise en place d'astreintes doit être prévue par accord d'entreprise. Votre entité n'en disposant pas, **les dispositions de la convention collective s'appliquent**, avec une rémunération de **49,27 € par jour**.

La rémunération de l'astreinte est distincte de celle de l'intervention. Le temps d'intervention, y compris le trajet, est du temps de travail effectif rémunéré comme tel, avec les majorations éventuelles pour heures supplémentaires.

Une période d'astreinte s'entend comme une période pendant laquelle, sans être à la disposition permanente et immédiate de l'employeur, **vous avez l'obligation de demeurer à votre domicile ou à proximité afin d'être en mesure d'intervenir** pour effectuer un travail au service de l'entreprise, la durée de cette intervention étant considérée comme un temps de travail effectif.
:::popup +
Le salarié d'astreinte doit garder son téléphone allumé, répondre aux appels, pouvoir se rendre sur son lieu de travail dans un délai maximum de deux heures et prévenir immédiatement sa hiérarchie en cas d'empêchement.
:::

Un salarié **peut être d'astreinte pour une semaine ou plusieurs jours** d'une même semaine.
:::popup +
Le planning des astreintes doit être porté à la connaissance des salariés concernés au moins 15 jours à l'avance, sauf circonstances exceptionnelles (délai réduit à 1 jour franc).
:::
...
**Le passage à temps partiel peut être demandé par un salarié à temps complet**.
:::popup +
En principe, la durée minimale d'un contrat à temps partiel est de **24 heures par semaine** (ou équivalent mensuel/annuel). Une durée inférieure reste possible dans les cas prévus par la loi, notamment sur demande écrite du salarié.
:::

**Les salariés à temps partiel bénéficient des mêmes droits que les salariés à temps plein** : promotion, formation, évolution de carrière, ancienneté, prévoyance...
:::popup +
Ils peuvent aussi solliciter un entretien avec la DRH pour évoquer leur évolution professionnelle, leur formation, ou un **retour à temps complet**.
:::

**L'organisation des horaires est encadrée** : les horaires sont regroupés sur des journées ou demi-journées régulières, avec **au plus une interruption** d'activité dans la journée (et jamais supérieure à 2 heures). Chaque période de travail continue doit être d'au moins **2h30**.

Les salariés à temps partiel qui souhaitent prendre ou **reprendre un emploi à temps complet ont la priorité** pour l'attribution d'un emploi équivalent.

**Toute modification de la durée ou de la répartition des horaires** doit respecter un **délai de prévenance de 7 jours ouvrés** et faire l'objet d'un avenant au contrat de travail.

L'accord QVCT de la BPALC prévoit également un **temps partiel choisi** et un **temps partiel de fin de carrière** pour accompagner les salariés proches de la retraite.

:::popup Aménagement de fin de carrière
navigate: Aménagement de fin de carrière
:::
...
<!-- layout: image-right -->
<!-- image: heures_complementaires.jpg -->

**Les heures complémentaires sont des heures effectuées au-delà de la durée prévue dans le contrat de travail à temps partiel**.

Votre accord d'entreprise prévoit que les heures complémentaires ne peuvent **pas dépasser 1/3 de la durée prévue dans votre contrat**.
...
<!-- thumbnail: sommaire_salaire.jpg -->
<!-- layout: text-only -->
...
<img src="bpalc/images/salaire_min_intro.jpg" style="width:100%;max-width:300px;border-radius:12px;margin-bottom:20px" onerror="this.remove()">
<strong style="font-size:1.3em">Salaire minimum</strong>
<p style="margin-top:8px">Le salaire minimum conventionnel est la rémunération minimale prévue par les grilles de classification de votre convention collective de branche.</p>
<div style="margin-top:auto;padding-top:24px"><button class="popup-btn" onclick="navigateToTitle('Salaire minimum hiérarchique')">Voir plus</button></div>
</div>
<div style="flex:1;max-width:380px;text-align:center;display:flex;flex-direction:column;align-items:center">
<img src="bpalc/images/heures_majorees_intro.jpg" style="width:100%;max-width:300px;border-radius:12px;margin-bottom:20px" onerror="this.remove()">
<strong style="font-size:1.3em">Heures majorées</strong>
<p style="margin-top:8px">Ce sont les heures payées plus qu'une heure normale de travail (heures supplémentaires, complémentaires, travail de nuit, travail du dimanche...)</p>
<div style="margin-top:auto;padding-top:24px"><button class="popup-btn" onclick="navigateToTitle('Heures supplémentaires et complémentaires')">Voir plus</button></div>
</div>
<div style="flex:1;max-width:380px;text-align:center;display:flex;flex-direction:column;align-items:center">
...
<!-- layout: image-right -->
<!-- image: salaire_min.jpg -->
<!-- subsection: Salaire minimum -->
...
| | Niveau | Embauche | 5 ans | 10 ans | 15 ans | 20 ans |
|:---|:---:|---:|---:|---:|---:|---:|
| Techniciens | A | 21 976 € | 22 213 € | 22 882 € | 23 560 € | 24 264 € |
| | B | 22 332 € | 22 573 € | 23 251 € | 23 954 € | 24 669 € |
| | C | 22 804 € | 23 050 € | 23 743 € | 24 459 € | 25 184 € |
| | D | 23 826 € | 24 071 € | 24 795 € | 25 535 € | 26 301 € |
| | E | 24 953 € | 25 219 € | 25 977 € | 26 757 € | 27 560 € |
| | F | 27 218 € | 27 512 € | 28 338 € | 29 189 € | — |
| | G | 30 163 € | 30 464 € | 31 380 € | 32 351 € | — |
| Cadres | H | 33 271 € | 33 605 € | 34 613 € | — | — |
| | I | 40 652 € | 41 058 € | 42 286 € | — | — |
| | J | 49 115 € | 49 604 € | 51 095 € | — | — |
| | K | 58 437 € | 59 030 € | 60 799 € | — | — |
:::

Si pendant **5 années consécutives**, votre salaire a évolué **de moins de 3 % par rapport au minimum** prévu par la convention collective pour votre poste et votre ancienneté, vous avez droit à une augmentation garantie appelée **« garantie salariale individuelle »**.
:::popup +
...
<!-- layout: image-left -->
<!-- image: heures_majorees.jpg -->
<!-- subsection: Heures majorées -->

Votre convention collective prévoit que les **heures supplémentaires** peuvent donner lieu soit **à une majoration de la rémunération**, soit **à du repos compensateur**. Lorsque ces heures sont majorées, l'application se fait de la manière suivante :

- Les 8 premières heures supplémentaires sont majorées de **25 %**,
- Les heures supplémentaires effectuées au-delà sont quant à elles **majorées de 50 %**.
...
<img src="bpalc/images/travail_nuit.jpg" style="width:100%;border-radius:12px" onerror="this.remove()">
</div>
<div style="flex:1">
<h2 style="font-size:1.4em;font-weight:800;margin-bottom:6px">Travail de nuit</h2>
<p>Le Code du travail indique que les heures travaillées <strong>entre 21 heures et 6 heures du matin</strong> sont considérées comme du travail de nuit.</p>
<p style="margin-top:6px">Le travail de nuit ouvre droit à un <strong>repos compensateur obligatoire</strong> équivalent à la durée de la vacation de nuit.</p>
<p style="margin-top:8px;text-align:center"><button class="popup-btn" data-popup="0">Qui est considéré comme un travailleur de nuit régulier ?</button></p>
</div>
</div>

:::popup _nuit
Est considéré comme travailleur de nuit régulier tout salarié qui accomplit au moins 2 fois par semaine, selon son horaire de travail habituel, au moins 3 heures de travail de nuit, ou qui accomplit au moins 270 heures de travail de nuit sur une période de 12 mois consécutifs.
:::

:::popup _dimanche
Le système TARGET et les services de la Bourse désignent des activités bancaires spécifiques liées à la continuité des marchés financiers et des flux de paiements, qui ont la particularité de fonctionner certains jours fériés.

Les techniciens du système TARGET et de la Bourse bénéficient d'une majoration de 100 % lorsqu'ils travaillent un jour férié.
:::

<div style="display:flex;gap:20px;align-items:flex-start;margin-top:8px">
<div style="flex:1">
<h2 style="font-size:1.4em;font-weight:800;margin-bottom:6px">Travail du dimanche et jours fériés</h2>
<div class="marker-rows">
<div class="marker-row"><div class="marker-row-text"><p>Le dimanche est un jour de <strong>repos obligatoire</strong> pour l'ensemble des salariés. Votre accord d'entreprise prévoit toutefois une <strong>majoration de 250 %</strong> pour les heures travaillées les <strong>dimanches et jours fériés</strong>.</p></div></div>
<div class="marker-row"><div class="marker-row-text"><p>Cette majoration de 250 % (taux de base majoré de 150 %) est un <strong>avantage significatif</strong> par rapport aux 30 % prévus par la convention collective de branche. Tout ou partie de cette indemnisation peut être <strong>transformée en temps de repos</strong>.</p></div></div>
<div class="marker-row"><div class="marker-row-text"><p>Votre convention collective prévoit également des <strong>majorations spécifiques</strong> pour les salariés du système <strong>TARGET et de la Bourse</strong>.</p></div><div class="marker-row-btn"><button class="marker-btn" data-popup="1">+</button></div></div>
</div>
</div>
<div style="flex:0 0 190px">
<img src="bpalc/images/jours_feries.jpg" style="width:100%;border-radius:12px" onerror="this.remove()">
</div>
</div>
...
<span class="bullet">•</span>Médaille du travail
:::popup +
À la BPALC, **trois types de médailles** coexistent :

**1. Médailles d'honneur du travail** (4 échelons) :
- Argent (20 ans), Vermeil (30 ans), Or (35 ans), Grande médaille d'or (40 ans)
- **Prime : 1 mois de salaire conventionnel** (1/13e du salaire de base annuel)

**2. Médaille de Bronze du Crédit Populaire** (30 ans) : 1 mois de salaire conventionnel (1/13e du salaire de base annuel)

**3. Médailles de la Société Industrielle de l'Est :**
- Argent (15 ans) : 153 € / Vermeil (25 ans) : 229 € / Or (35 ans) : 305 € / Grande Médaille d'Or (40 ans) : 382 €
:::

<span class="bullet">•</span>Prime de crèche
:::popup +
La convention collective de la branche Banque Populaire prévoit une indemnité de crèche ou de garde. L'accord QVCT de la BPALC prévoit qu'au retour à temps plein d'un congé maternité, d'adoption ou parental à temps plein, la **prime de crèche est doublée** jusqu'aux 3 ans de l'enfant.
:::

<span class="bullet">•</span>Indemnité de transport en commun
:::popup +
L'employeur prend en charge **50 % du prix des abonnements** de transport en commun souscrits par les salariés pour leurs trajets domicile-travail. Cette prise en charge est obligatoire.
:::

<span class="bullet">•</span>Contrepartie temps de trajet inhabituel
:::popup +
Lorsque votre temps de trajet aller-retour dépasse d'au moins **30 minutes** votre trajet habituel, vous bénéficiez d'un **repos d'une durée équivalente au temps supplémentaire** (franchise de 30 min déduite), dans la limite de 3 heures par jour.

Ce repos doit être pris dans le **mois glissant** suivant le déplacement.
:::

<span class="bullet">•</span>Prime de diplôme
:::popup +
Votre convention collective prévoit une prime versée en une seule fois à l'obtention d'un diplôme par la voie de la **formation professionnelle continue** (hors contrats d'apprentissage et de professionnalisation) :

| Diplôme | Montant |
|---------|---------|
| Certificat IMB (intégration mobilité bancaire), en remplacement du BP Banque, pour l'obtention de l'intégralité du parcours (4 blocs) | **1 600 €** |
| BTS Banque | **1 600 €** |
| Licence pro conseiller clientèle expert | **1 700 €** |
| Licence pro banque / cycle conseiller clientèle de professionnels / cycle conseiller patrimonial agence | **1 700 €** |
| Bachelor conseiller bancaire clientèle de professionnels | **1 700 €** |
| MBA gestion de patrimoine / Master gestion de patrimoine / CESB expert en gestion de patrimoine | **1 900 €** |
| ITB management bancaire | **1 900 €** |
:::
...
- Congé déménagement : 10 jours
- Frais d'installation : 5 000 € + 750 €/enfant
- Double résidence : 1 000 €/mois (max 9 mois)
- Aide à l'emploi du conjoint : 3 500 €
:::
...
## Contrat de travail
<!-- thumbnail: sommaire_contrat.jpg -->
<!-- layout: text-only -->

<div style="display:flex;gap:40px;justify-content:center;flex-wrap:wrap;padding:0 32px">
<div style="flex:1;max-width:380px;text-align:center;display:flex;flex-direction:column;align-items:center">
<img src="bpalc/images/contrat_intro.jpg" style="width:100%;max-width:300px;border-radius:12px;margin-bottom:20px" onerror="this.remove()">
<strong style="font-size:1.3em">Mentions obligatoires et période d'essai</strong>
<p style="margin-top:8px">Votre contrat de travail doit obligatoirement comporter certaines mentions pour être valable. La période d'essai permet à votre employeur d'évaluer vos compétences. Elle vous aide également à apprécier votre nouvel environnement de travail.</p>
<div style="margin-top:auto;padding-top:24px"><button class="popup-btn" onclick="navigateToTitle('Mentions obligatoires (CDI)')">Voir plus</button></div>
</div>
<div style="flex:1;max-width:380px;text-align:center;display:flex;flex-direction:column;align-items:center">
...
<strong style="font-size:1.3em">Contrat d'auxiliaire d'été</strong>
<p style="margin-top:8px">Votre convention prévoit la possibilité de proposer des contrats d'auxiliaire de vacances pour les jeunes en cours de scolarité pendant les vacances scolaires ou universitaires.</p>
<div style="margin-top:auto;padding-top:24px"><button class="popup-btn" onclick="navigateToTitle('Contrat d\'auxiliaire d\'été')">Voir plus</button></div>
</div>
</div>
...
<!-- layout: image-right -->
<!-- image: mentions_contrat.jpg -->
<!-- subsection: Mentions obligatoires et période d'essai -->

Votre convention collective prévoit les mentions obligatoires devant figurer dans votre contrat de travail :

- la nature du contrat ;
- les conditions d'emploi avec notamment :
    - le montant et le mode de rémunération,
    - la classification.

De manière assez classique, votre contrat comportera également la plupart du temps l'identité et l'adresse des parties, la date d'embauche, le lieu de travail, la durée de la période d'essai, et le délai de préavis en cas de rupture du contrat.
...
<!-- layout: text-only -->
<!-- condition: mobilite_geo -->
<!-- subsection: Mentions obligatoires et période d'essai -->
<!-- title: Modification et mobilité -->

<div style="display:flex;gap:20px;align-items:flex-start;margin-bottom:10px">
<div style="flex:0 0 190px">
<img src="bpalc/images/modif.jpg" style="width:100%;border-radius:12px" onerror="this.remove()">
</div>
<div style="flex:1">
<div class="marker-rows">
...
<div style="flex:0 0 190px">
<img src="bpalc/images/mobilite.jpg" style="width:100%;border-radius:12px" onerror="this.remove()">
</div>
</div>

:::popup _rythme
Vos accords précisent qu'un changement de rythme de travail constitue un simple changement des conditions de travail et ne requiert pas l'accord préalable des salariés concernés, dès lors que la durée annuelle de travail est maintenue. La mise en œuvre d'un changement de rythme de travail ne peut toutefois intervenir qu'en respectant un délai de prévenance de **3 mois calendaires**.
:::
...
**La mobilité géographique entraînant un trajet domicile/lieu de travail de plus de 40 km aller et retour par jour**

Dans ce premier cas, les salariés BPALC bénéficient :
- d'une prise en charge intégrale de l'abonnement de transport en commun sur 3 ans,
- ou à défaut de pouvoir prendre les transports en commun, d'une prise en charge des frais kilométriques à hauteur de **0,17 €/km** à compter du 41e km et des surcoûts des frais de péage liés à la nouvelle affectation, pendant un maximum de **2 ans**. Au titre de la 3e année et si le salarié n'a pas déménagé, il lui sera versé une prime de compensation à l'éloignement prolongé.

**La mobilité géographique entraînant un trajet domicile/lieu de travail de plus de 50 km aller et un temps de trajet aller ou retour au moins égal à 1h30**
...
:::popup _demenagement
Le salarié concerné bénéficiera également de la prise en charge de **2 nuits pour 2 personnes** pour son déménagement dans la limite du barème en vigueur prévu en cas de déplacements professionnels.
:::
...
**Prêts préférentiels :**
BPALC propose des prêts relais d'une durée maximale de **24 mois** dont le montant est fixé à **85 %** de la valeur du bien, et des prêts amortissables de **240 mois** pour l'acquisition du nouveau logement.

**Aide à la recherche d'un nouvel emploi du conjoint :**
...
:::popup +
Votre convention prévoit qu'un entretien doit avoir lieu au moins 5 jours ouvrés avant la fin de la période d'essai et, en cas de renouvellement, au moins 5 jours ouvrés avant la fin de ce renouvellement.
:::
...
:::popup Délai de prévenance employeur
- 48 heures en deçà d'un mois de présence dans l'entreprise,
...
Concrètement, **quelles conséquences pour vous ?** Après une rupture de votre contrat, votre employeur peut activer cette clause avec l'objectif de vous empêcher de rejoindre une banque concurrente.
...
<!-- layout: image-right -->
<!-- image: non_concurrence_2.jpg -->
<!-- subsection: Clause de non-concurrence -->

Parce que ce type de clause a fait l'objet de nombreux abus côté employeur, la jurisprudence encadre de manière assez stricte son utilisation. Votre clause est considérée comme valable si et seulement si :

<span class="bullet">•</span>elle est **limitée dans le temps** (la jurisprudence considère excessive une durée supérieure à 2 ans) **et dans l'espace** (département, région, France entière...),

<span class="bullet">•</span>elle est **liée à une activité spécifiquement visée**,

<span class="bullet">•</span>une **contrepartie financière** est prévue au contrat.
:::popup +
Votre convention et vos accords d'entreprise ne prévoient pas le montant de la contrepartie financière. La jurisprudence considère une contrepartie financière de 10 % du salaire comme dérisoire. Elle est en général au moins égale à 20 % de votre ancien salaire pendant autant de mois que la durée de validité de la clause.
:::
...
:::popup cftc
Votre syndicat peut vous accompagner dans cette démarche.
:::
...
<!-- layout: image-left -->
<!-- image: auxiliaire.jpg -->
<!-- subsection: Contrat d'auxiliaire d'été -->

Juridiquement, le contrat d'auxiliaire d'été est un **CDD d'usage (CDDU)**. Ce type de CDD est utilisé dans les secteurs où il est d'usage de ne pas recourir au CDI, en raison de la nature de l'activité exercée et du caractère temporaire de ces emplois.

Votre convention collective reconnaît ce dispositif pour le secteur bancaire et prévoit la possibilité de proposer des contrats d'auxiliaire de vacances à des jeunes en cours de scolarité pendant les vacances scolaires ou universitaires.
...
## Épargne salariale
<!-- thumbnail: sommaire_epargne_salariale.jpg -->
<!-- layout: text-only -->

<div style="display:flex;gap:40px;justify-content:center;flex-wrap:wrap;padding:0 32px">
<div style="flex:1;max-width:380px;text-align:center;display:flex;flex-direction:column;align-items:center">
<img src="bpalc/images/interessement_participation_intro.jpg" style="width:100%;max-width:300px;border-radius:12px;margin-bottom:20px" onerror="this.remove()">
<strong style="font-size:1.3em">Intéressement et participation</strong>
<p style="margin-top:8px">Découvrez les critères et modalités de répartition de l'intéressement et de la participation au sein de votre entreprise.</p>
<div style="margin-top:auto;padding-top:24px"><button class="popup-btn" onclick="navigateToTitle('Intéressement')">Voir plus</button></div>
</div>
<div style="flex:1;max-width:380px;text-align:center;display:flex;flex-direction:column;align-items:center">
<img src="bpalc/images/PEE_intro.jpg" style="width:100%;max-width:300px;border-radius:12px;margin-bottom:20px" onerror="this.remove()">
<strong style="font-size:1.3em">PEE</strong>
<p style="margin-top:8px">Le PEE vous permet de faire des placements en bénéficiant d'un abondement de votre entreprise et d'un avantage fiscal. Découvrez dans le détail ce qui est prévu à la BPALC.</p>
<div style="margin-top:auto;padding-top:24px"><button class="popup-btn" onclick="navigateToTitle('PEE')">Voir plus</button></div>
</div>
<div style="flex:1;max-width:380px;text-align:center;display:flex;flex-direction:column;align-items:center">
<img src="bpalc/images/PERCO_intro.jpg" style="width:100%;max-width:300px;border-radius:12px;margin-bottom:20px" onerror="this.remove()">
<strong style="font-size:1.3em">PERCOL-I</strong>
<p style="margin-top:8px">Le PERCOL-I vous permet d'épargner pour préparer votre retraite en bénéficiant de conditions avantageuses (abondement employeur, avantage fiscal).</p>
<div style="margin-top:auto;padding-top:24px"><button class="popup-btn" onclick="navigateToTitle('PERCOL-I')">Voir plus</button></div>
</div>
</div>
...
### Intéressement
<!-- layout: image-left -->
<!-- image: interessement_1.jpg -->
<!-- subsection: Intéressement et participation -->

L'intéressement est un dispositif d'épargne salariale qui permet aux salariés de participer aux résultats ou à la performance de l'entreprise. Il vise à encourager les salariés à s'impliquer dans la réalisation des objectifs de l'entreprise.

<div style="display:flex;align-items:center;gap:24px">
<p style="flex:1;margin:0">Au sein de la BPALC, un accord d'entreprise régit les règles de l'intéressement pour les <strong>exercices 2025, 2026 et 2027</strong>.</p>
<a href="https://larchipel.io/wp-content/uploads/Accord-Interessement-2025-2027.pdf" target="_blank" class="popup-btn" style="flex-shrink:0;text-decoration:none">Consulter votre accord</a>
</div>
...
- **percevoir une partie ou la totalité de votre prime d'intéressement** tout de suite. Elle sera alors imposable à l'impôt sur le revenu,
...
En l'absence de choix de votre part dans le délai imparti (15 jours), votre prime d'intéressement est affectée automatiquement dans le **FCPE Natixis ES Monétaire** du PEE de la BPALC, pour une durée d'indisponibilité de 5 ans.
:::
...
La participation est un **mécanisme de redistribution des bénéfices de l'entreprise aux salariés**. Contrairement à l'intéressement, elle est obligatoire pour les entreprises de plus de 50 salariés. On appelle réserve spéciale de participation (RSP) la part de bénéfice à distribuer aux salariés.

<div style="display:flex;align-items:center;gap:24px">
<p style="flex:1;margin:0">Au sein de la BPALC, un accord d'entreprise signé en juin 2025 régit les règles de la participation pour les <strong>exercices 2025, 2026 et 2027</strong>.</p>
<a href="https://larchipel.io/wp-content/uploads/Accord-de-Participation-2025-2027.pdf" target="_blank" class="popup-btn" style="flex-shrink:0;text-decoration:none">Consulter votre accord</a>
</div>
...
L'application de cette formule ne peut pas conduire à ce que la participation soit inférieure à celle qui aurait été obtenue avec la formule légale.
:::popup +
La formule légale de droit commun est la suivante :

**RSP = 1/2 x (B - 5%C) x S/VA**

Où B = bénéfice net, C = capitaux propres, S = salaires, VA = valeur ajoutée.

La formule dérogatoire de la BPALC ne peut en aucun cas aboutir à un montant inférieur à cette formule légale.
:::

**La participation est répartie proportionnellement au salaire.**
:::popup +
La rémunération prise en compte est plafonnée à **3 fois le plafond annuel de la sécurité sociale (PASS)**.

La prime individuelle de participation est elle-même plafonnée à **3/4 du PASS**.
:::

Vous pouvez choisir de :
- percevoir une partie ou la totalité de votre prime de participation tout de suite. Elle sera alors imposable à l'impôt sur le revenu,
- verser une partie ou la totalité de votre prime sur les plans d'épargne salariale (voir plus loin).
...
**Plafond d'abondement : 2 000 € brut par an.**

**Exemple :** vous placez 3 000 € d'intéressement sur votre PEE. Votre employeur abonde : 500 € (100 % sur les 500 premiers €) + 300 € (20 % sur 1 500 €) + 150 € (15 % sur 1 000 €) = **950 € d'abondement**.
:::
